...
def parse_args():
    parser = argparse.ArgumentParser(description="Generate English word embeddings.")
...
def main():
    ...
    model_name = "word_embedding_wiki" if args.corpus_source == "wikipedia" else "word_embedding"
    em.words_embedding(model_name=model_name, size=150)
